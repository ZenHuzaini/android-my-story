...
public class MainActivity extends AppCompatActivity {
    ...
    private Button openMyStoryActivityBtn,openUploadActivityBtn, storyImage;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        openMyStoryActivityBtn = findViewById ( R.id.openMyStoryActivityBtn );
        openUploadActivityBtn = findViewById ( R.id.openUploadActivityBtn );
        storyImage = findViewById(R.id.storyImage);

        openMyStoryActivityBtn.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void openCamera(){
        ...
        if(intent.resolveActivity(getPackageManager())!=null){
            ...
            if(photoFile != null){
                Uri photoURI = FileProvider.getUriForFile(this,"com.zen.mystory._fileprovider",photoFile);
    ...
    protected void onActivityResult(int requestCode,int ResultCode,Intent data){
        ...
        if(requestCode == REQUEST_IMAGE_CAPTURE && ResultCode == Activity.RESULT_OK){
            ...
            if (pickedImage == null){
                Log.i("onActivityResult", "onActivityResult: null");
            }
            String[] filePath = {MediaStore.Images.Media.DATA};
            Cursor cursor = getContentResolver().query(pickedImage,filePath,null,null,null);
            cursor.moveToFirst();
            mCurrentPhotoPath = cursor.getString(cursor.getColumnIndex(filePath[0]));
            Log.i("this onActivityResult", "this onActivityResult: "+ mCurrentPhotoPath);
